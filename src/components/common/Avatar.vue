<template>
    <div>
        <a-avatar :image-url="props.avatar" :size="props.size" v-if="props?.avatar && props?.avatar !== ''"
            :trigger-icon-style="{
                minWidth: '15px',
                minHeight: '15px',
            ...
            <template #trigger-icon v-if="props.showEditButton">
                <icon-edit @click="emit('click-icon')" :style="{
                    minWidth: '9px',
                    minHeight: '9px',
        ...
        <a-avatar :size="props.size" :style="{ backgroundColor: props.backgroundColor }" :trigger-icon-style="{
            minWidth: '15px',
            minHeight: '15px',
            width: `${(props.size / 4)}px`,
            height: `${(props.size / 4)}px`,
